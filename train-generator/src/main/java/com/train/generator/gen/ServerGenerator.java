...
public class ServerGenerator {
    ...
    static String serverPath = "[module]/src/main/java/com/train/[packages]/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        module = generatorPath.replace("src/main/resources/generator-config-", "train-").replace(".xml", "");
        packages = module.replace("train-", "");
        System.out.println("module: " + module);
        serverPath = serverPath.replace("[module]", module);
        serverPath = serverPath.replace("[packages]", packages);
